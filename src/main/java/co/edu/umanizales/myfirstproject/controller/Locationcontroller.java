...
public class Locationcontroller {
    ...
    @GetMapping("/longer-than/{length}")
    public List<Location> getLocationsWithNameLongerThan(@PathVariable int length) {
        return locationService.getLocationsWithNameLongerThan(length);
    }
